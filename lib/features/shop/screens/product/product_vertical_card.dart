            ...
            children: [
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Text(name,
                        style: TextStyle(color:dark?Colors.white:Colors.grey[800], fontSize: 9, fontWeight: FontWeight.bold)),
                    SizedBox(
                      height: 5,
                    ),
                    Text(brand_name,
                        style: TextStyle(color: dark?Colors.white:Colors.grey[600], fontSize: 6, fontWeight: FontWeight.bold)),
                    SizedBox(height: 2),
                    Text(price,
                        style: TextStyle(color:dark? Colors.white:Colors.black, fontSize: 9, fontWeight: FontWeight.bold)),
                  ],
                ),
              ),
                 Positioned(
